    ...
    <div
        ...
        <div class="grid flex-1 grid-cols-1 gap-5 md:grid-cols-2">
            <div
                ...
                :key="card.key"
                class="flex h-full flex-col rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                <p
                    class="mb-2 text-xs font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400">
                    {{ card.label }}
                </p>
                <p
                    class="mt-auto text-4xl font-black"

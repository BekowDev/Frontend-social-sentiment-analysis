...
<template>
    <aside
        class="flex h-full w-72 shrink-0 flex-col border-r border-gray-200 bg-gray-50"
    >
        <div
        ...
        <div class="custom-scrollbar flex-1 overflow-y-auto p-0">
            ...
            >
                ...
                <div
                    class="mt-1 flex gap-3 text-[10px] text-gray-500 dark:text-gray-400"
                >
                    ...
                    >
                        ⏱ {{ formatExecutionTimeSeconds(item.executionTime) }}
                    </span>
                </div>

                <div
                    class="absolute top-0 bottom-0 left-0 w-1 bg-blue-600 opacity-0 transition-opacity group-hover:opacity-100"
                ></div>
            </button>
        </div>
    </aside>
